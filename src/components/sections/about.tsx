    ...
    <section id="about" className="mx-auto max-w-6xl scroll-mt-24 px-6 py-24 sm:py-32">
      <div className="grid items-center gap-12 lg:grid-cols-2">
        ...
        <Reveal delay={2} className="relative">
          <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-surface to-surface-2 p-8 shadow-xl">
            ...
            <div className="relative z-10 flex flex-col justify-between h-full">
              ...
              <div>
                ...
                <p className="text-sm text-accent-2 font-medium mt-1">{profile.role}</p>
